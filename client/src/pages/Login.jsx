    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          'Oops! Login failed. Please check your email and password.'
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    ...
    >
      <style>{`
        ...
        .ccl-building {
          transition: filter 0.7s ease, transform 0.4s ease;
        }

        .ccl-building.grumbled {
          filter: grayscale(1) brightness(0.85);
        }

        .ccl-building.popped {
          animation: ccl-pop 0.55s ease;
        }
        ...
        .ccl-input:focus {
          outline: 3px solid var(--focus-color, #8C6FFF);
          outline-offset: 2px;
        }
        ...
        .ccl-float {
          animation: ccl-float 4.5s ease-in-out infinite;
        }
        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="ccl-serif text-slate-200 text-xs md:text-sm">
              Ministry of Playful Justice &nbsp;•&nbsp; Official Player Portal
            </p>
          </div>
        </div>
      </header>
      ...
      <main className="relative flex-1 flex items-center justify-center overflow-hidden py-10 px-4">
        ...
        >
          ...
          >
            ...
            {BUILDINGS.map((b) => {
              ...
              const winRows = Math.max(
                1,
                Math.floor((b.height - 20) / 34)
              );
              ...
              return (
                ...
                >
                  <rect
                    ...
                    rx="12"
                    fill={b.color}
                    className={`ccl-building ${
                      isFilled ? 'popped' : 'grumbled'
                    }`}
                  />
        ...
        <div className="relative z-10 w-full max-w-2xl">
          <div className="ccl-glass rounded-3xl shadow-2xl border border-white/50 overflow-hidden">
            ...
            <div className="ccl-glass-dark px-6 py-3 flex items-center justify-between">
            ...
            <div className="p-6 md:p-8">
              <div className="text-center mb-7">
                <h2
                  className="ccl-display text-3xl md:text-4xl font-extrabold"
                  style={{ color: '#0B3558' }}
                >
                  Welcome Back! 👋
                </h2>
                ...
                <p className="ccl-body text-slate-700 font-semibold text-sm mt-1">
                  Enter your details and continue your adventure.
                </p>
              </div>
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="cursor-pointer w-full mt-4 p-3.5 rounded-xl font-black text-lg transition-all duration-150 active:translate-y-1 flex justify-center items-center gap-2 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  style={{
                ...
                >
                  {loading
                    ? 'Entering the City...'
                    : 'Enter Child Law City 🚀'}
                </button>
              </form>

              <div className="text-center mt-6">
                <p className="ccl-body text-sm font-semibold text-slate-700">
      ...
      >
        <div className="max-w-6xl mx-auto px-4 py-3 text-xs flex flex-wrap items-center justify-between gap-1">
          <span>
            © 2026 Child Law City. Content owned by the Ministry of
            Playful Justice.
          </span>

          <span>
            Portal last reviewed & updated on {today}
          </span>
        </div>
      </footer>
    </div>
